...
import 'package:norandy_app/pages/login_page.dart';
      ...
      backgroundColor: Colors.black,
        body: ListView(
          padding: const EdgeInsets.all(20),
            ...
            const Text("Sign In", textAlign: TextAlign.center, style: TextStyle(fontSize: 30,fontWeight: FontWeight.bold, color: Colors.amberAccent),),
                    ...
                    TextFormField(
                      ...
                      decoration: const InputDecoration(
                        ...
                        enabledBorder: OutlineInputBorder(
                          ...
                          borderSide: BorderSide(color: Colors.amber, width: 1.0, style: BorderStyle.solid)
                        ),
                        hintText: 'Email',
